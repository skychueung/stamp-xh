...
_READINESS_META: dict[str, dict[str, Any]] = {
    ...
    "ppflow": {
        "readiness_gate": "P33G_CONTROLLED_SMOKE_VERIFIED_FROZEN",
        "readiness_level": "controlled_smoke_verified",
        "blocker_code": "REAL_RUN_GATE_CLOSED",
        "next_authorization": "NEW_EXPLICIT_AUTH_REQUIRED_FOR_ANY_FUTURE_EXECUTION",
        "evidence_ref": "STAMP_P33G_PPFLOW_POST_RUN_AUDIT.md / p33g_ppflow_cpu1800_retry_20260628_201844",
        "last_verified_at": "2026-06-28T20:18:00+00:00",
    },
    "pepglad": {
        "readiness_gate": "P33I_OUT_OF_SCOPE_EXECUTION_EVIDENCE_PRESERVED",
        "readiness_level": "pending_probe",
...
def _derive_activation_requirements(model_id: str, product_group: str) -> str:
    mid = model_id.lower().strip()
    if product_group == "available_six":
        return "NEW_EXPLICIT_AUTH_REQUIRED_FOR_ANY_FUTURE_EXECUTION"
    if mid == "pepprclip":
        return "MiniCLIP checkpoint + HF token/license + explicit gate open"
    if product_group == "reserved_placeholder":
        return "NEW_EXPLICIT_AUTH_REQUIRED_FOR_ANY_FUTURE_EXECUTION; fresh compliant controlled smoke required"
...
_MODEL_REGISTRY: list[dict[str, object]] = [
    ...
    },
    {
        ...
        "input_type": "target_sequence_plus_structure",
        "status": MODEL_STATUS_CONTROLLED_SMOKE_VERIFIED,
        "status_reason": "p33g_controlled_smoke_verified",
        "stage": "P33G_CONTROLLED_SMOKE_OK",
        "description": "PPFlow (controlled_smoke_verified): torsional flow-matching peptide design. P33G V2 controlled CPU smoke completed with an independent authorized chain; preserved and frozen. P33H out-of-scope execution does not affect this status.",
        "requires_structure": True,
        "requires_gpu": True,
        "notes": "P33G: V2 controlled CPU smoke SUCCESS, exit code 0, 133 samples, manifest verified. Frozen and preserved as the compliant success evidence under P33G. P33I audit confirmed P33H out-of-scope execution does not affect this status. All outputs NOT_EXPERIMENTALLY_VALIDATED. Real execution requires new explicit authorization.",
        "supports_probe": True,
        "supports_dry_run": True,
        "supports_real_run": False,
        "supports_structure_output": False,
