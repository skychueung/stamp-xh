#!/usr/bin/env python3
"""P6h Complex ColabFold Output Parser.
...
def parse_complex_output(output_dir: str | Path) -> dict:
    ...
    if pdb_files:
        ...
        report["has_chain_A"] = any(line.startswith("ATOM") and line[21:22].strip() == "A" for line in pdb_text.splitlines())
        report["has_chain_B"] = any(line.startswith("ATOM") and line[21:22].strip() == "B" for line in pdb_text.splitlines())
...
def main() -> int:
    ...
    report = parse_complex_output(output_dir)
