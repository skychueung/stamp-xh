...
class ModelConfig:
    ...
    For models with more than one checkpoint or model-specific config file
    (e.g. PepHAR density + prediction), ``model_configs`` lists every file
...
def _diffpepbuilder_base_config() -> str:
    return "/mnt/sdb/kxc/stamp_models/source/diffpepbuilder/extracted_p24_install_probe/DiffPepBuilder-main/config/base.yaml"
...
def _pepflow_command(ctx: Dict[str, Any]) -> List[str]:
    ...
    return [
        ...
        cfg.source_path,
        "--config",
        configs_by_name["learn_angle_config"]["path"],
        "--ckpt",
        cfg.checkpoint_path,
        "--receptor",
...
MODEL_CONFIGS: List[ModelConfig] = [
    ...
    ModelConfig(
        ...
        order=3,
        source_path="/mnt/sdb/kxc/stamp_models/source/diffpepbuilder/extracted_p24_install_probe/DiffPepBuilder-main/experiments/run_inference.py",
        ...
        runner_script_path="/mnt/sdb/kxc/stamp_models/scripts/stamp_diffpepbuilder_p33l_real_runner.py",
        runner_script_sha256="09ed88320f9eef8dd5e8bb40814620e3a8c117d7c21a1e131a8fa9f2ec039d29",
        ...
        model_configs=[
            {
                "name": "base_config",
                "path": "/mnt/sdb/kxc/stamp_models/source/diffpepbuilder/extracted_p24_install_probe/DiffPepBuilder-main/config/base.yaml",
                "sha256": "f952e17a4fa134cbbd736453b423ee99e14583d9fcbd202db16c10c0af9b2e26",
            },
            {
                "name": "inference_config",
                "path": "/mnt/sdb/kxc/stamp_models/source/diffpepbuilder/extracted_p24_install_probe/DiffPepBuilder-main/config/inference.yaml",
                "sha256": "d1e1860ed368f10742f60b7f2ec6088684d3cc501883db844ae5efccbb5225c3",
            },
        ],
    ),
    ModelConfig(
        ...
        model_configs=[
            {
                "name": "learn_angle_config",
                "path": "/mnt/sdb/kxc/stamp_models/source/pepflow/extracted_p25_install_probe/PepFlowww-main/configs/learn_angle.yaml",
                "sha256": "35fb093d8e4537de0029244cbd92a079b9b0eb61347714fa38202c2579764dd7",
            },
        ],
    ),
    ModelConfig(
        ...
        display_name="PepHAR",
        order=5,
        source_path="/mnt/sdb/kxc/stamp_models/source/pephar/extracted_p25_install_probe/PepHAR-main/evaluate/sample.py",
        source_sha256="f84f6a20f95dd644fd8d5952c7a7c61e58612310d80fd2756a2e4e24f2991a85",
        checkpoint_path="/mnt/sdb/kxc/stamp_models/checkpoints/pephar/p25_install_probe/PepHAR_ICLR2025_SHARE/ckpts/prediction_d2_x2o1_2024_09_08__11_21_33/checkpoints/2400.pt",
        ...
        runner_script_path="/mnt/sdb/kxc/stamp_models/scripts/stamp_pephar_p33l_real_runner.py",
        runner_script_sha256="7b979aa2b1cd146e82523c5ea3356268aeb073a022c3dcbaa9ffebdd65d3265f",
        command_args=_pephar_command,
        timeout_seconds=3600,
        disk_quota_bytes=10 * 1024 * 1024 * 1024,
        max_output_files=1000,
        output_files=["sample_0.pdb", "manifest.json"],
        model_configs=[
            {
                "name": "density_checkpoint",
                "path": "/mnt/sdb/kxc/stamp_models/checkpoints/pephar/p25_install_probe/PepHAR_ICLR2025_SHARE/ckpts/density_v4_x5o2_2024_09_08__11_25_36/checkpoints/1400.pt",
                "sha256": "06b9a2701a9594158de2650d10da756c51dda3cc410ea98c47cf9fd1dbc32d15",
            },
            {
                "name": "density_config",
                "path": "/mnt/sdb/kxc/stamp_models/checkpoints/pephar/p25_install_probe/PepHAR_ICLR2025_SHARE/ckpts/density_v4_x5o2_2024_09_08__11_25_36/density_v4_x5o2.yml",
                "sha256": "6ccc4e972f069e86834c1675b5a47a03545c5a533600d77699e624b8f0828b24",
            },
            {
                "name": "prediction_checkpoint",
                "path": "/mnt/sdb/kxc/stamp_models/checkpoints/pephar/p25_install_probe/PepHAR_ICLR2025_SHARE/ckpts/prediction_d2_x2o1_2024_09_08__11_21_33/checkpoints/2400.pt",
                "sha256": "94eb9933312a4c851e3a6dae44f2435dcfc417648d271ca75e8c22bebc1523f6",
            },
            {
                "name": "prediction_config",
                "path": "/mnt/sdb/kxc/stamp_models/checkpoints/pephar/p25_install_probe/PepHAR_ICLR2025_SHARE/ckpts/prediction_d2_x2o1_2024_09_08__11_21_33/prediction_d2_x2o1.yml",
                "sha256": "e69485f9604772d2d2e99ce2a8f9155dd06e21ef125e171c0a8c964fa0d1f6c4",
            },
        ],
    ),
    ModelConfig(
